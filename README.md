...
- [📖 About the Project](#about-project)
  ...
  - [🚀 Link to Rails Back-end](#back-end)
...
**Hello-react-back-end** Implements a connection between a Ruby on Rails back-end and React front-end.
...
```sh
  cd my-folder
  git clone https://github.com/mrprotocoll/hello-react-front-end.git
```
...
https://github.com/mrprotocoll/hello-react-front-end
...
I would like to acknowledge and thank [Microverse](https://www.microverse.org/)
